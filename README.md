## О себе
Привет! Меня зовут Константин Брызгин. Прохожу обучение по профессии "Аналитик данных" в школе программирования Хекслет, а также учусь на втором курсе магистратуры по направлению "Информационные системы и технологии". Мне интересно развиваться в IT-сфере в области работы с данными. Ищу работу аналитиком данных / геоаналитиком.
